...
func TestUnmarshalUint(t *testing.T) {
	...
	maybePanic(err)
	assertUint(t, si, "int string json")
...
func TestUnmarshalUint64Overflow(t *testing.T) {
	...
	//err = json.Unmarshal([]byte(strconv.FormatUint(uint64Overflow, 10)), &i)
	//if err == nil {
	//	panic("err should be present; decoded value overflows uint64")
	//}
}
...
func TestTextUnmarshalUint(t *testing.T) {
	...
	maybePanic(err)
	assertNullUint(t, zero, "UnmarshalText() zero int")
